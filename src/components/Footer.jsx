      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            <div className="footer-logo">
              <img src={LogoKR} alt="KR PRIME CLEAN" />
              <div>
          ...
          <div className="footer-section">
            ...
            <ul>
              <li>
                <a href="#services">Limpeza de Sofás</a>
              </li>
              <li>
                <a href="#services">Limpeza de Tapetes</a>
              </li>
              <li>
                <a href="#services">Higienização de Colchões</a>
              </li>
              <li>
                <a href="#services">Impermeabilização</a>
              </li>
              <li>
                <a href="#services">Carrinho de Bebê</a>
              </li>
            </ul>
          </div>
          ...
          <div className="footer-section">
            ...
            <ul>
              <li>
                <i className="fas fa-phone"></i> (11) 94499-3638
              </li>
              <li>
                <i className="fas fa-envelope"></i> krprimeclean@gmail.com
              </li>
              <li>
              ...
              <li>
                <i className="fab fa-instagram"></i> @krprime_clean
              </li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-social">
            ...
            <a
              href="https://instagram.com/krprime_clean"
              target="_blank"
              rel="noopener noreferrer"
            >
